...
A post in the series points at the document. These carry the argument.
...
| Document | Shows |
| --- | --- |
| [game-vision-v2.md](game-vision-v2.md) | Product intent; the other half of the version arc |
| [combat-rules-v3.md](combat-rules-v3.md) | Doc-to-engine discipline that cites symbols rather than restating numbers |
| [game-size-unit-caps.md](game-size-unit-caps.md) | Same discipline at smaller scale |
